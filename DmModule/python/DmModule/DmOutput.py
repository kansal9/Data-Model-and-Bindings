...
"""
File: python/DmModule/DmOutput.py
...
# EXERCISE
#==============================================================================================
# Include the python packages and modules to write output XML file.
# GenericHeaderProvider to write header in XML file
#==============================================================================================
# Tip: You can just uncomment the line below
#==============================================================================================

from ST_DM_HeaderProvider.GenericHeaderProvider import GenericHeaderGenerator
#import ST_DataModelBindings.dpd.le3.wl.twodmass.inp.raw.paramsconvergencepatch_stub as out_devws
...
class DmOutput:
  ...
  def createOutputXml (output_xml_file, fits_filename):
        ...
        #
        logger.info('TODO: Create a data container pointing to the fits_filename ')
        ...
        logger.info('TODO: Create the Output Map element ')
        #NoisyMap = pro_devws.le3.wl.twodmass.twoDMassConvergencePatch.Factory()
        ...
        logger.info('TODO: Create Data element ')
        #data = pro_devws.le3.wl.twodmass.twoDMassCollectConvergencePatch.Factory()
        #value = 0
        ...
        #
        logger.info('TODO: Create the Optional Output Map element ')
        #data.NoisyConvergence = NoisyMap

        # Exercise
        # ---------------------------------------------------------
        # Create the product XML root element / Create the final object
        logger.info('TODO: Create the product xml root element ')
        ...
        #
        logger.info('TODO: Create the Output XML file ')
